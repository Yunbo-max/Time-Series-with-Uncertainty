# -*- coding: utf-8 -*-
# @Author: Yunbo
# @Date:   2024-05-13 18:58:30
# @Last Modified by:   Yunbo
# @Last Modified time: 2024-07-19 18:27:55
import pandas as pd
import statsmodels
...
class NeuralHarmonicModel(torch.nn.Module):
    ...
    def __init__(self, input_size=3, hidden_nodes=50, n_layers=1, k_order=5, t_order=1):
        ...
        self.input_layer = torch.nn.Linear(input_size, hidden_nodes)
        ...
        self.output_layer = torch.nn.Linear(self.hidden_nodes, 1)
    ...
    def forward(self, x, t):
        ...
        repr = self.activation_func(self.input_layer(fourier_components - x))
        repr = self.hidden_layers(repr)
        yhat = self.output_layer(repr)

        return yhat + fourier_components
